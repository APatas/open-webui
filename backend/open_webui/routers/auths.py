...
from open_webui.config import OPENID_PROVIDER_URL, ENABLE_OAUTH_SIGNUP, ENABLE_LDAP, OAUTH_CLIENT_ID
                        ...
                        if resp.status == 200:
                            ...
                            if logout_url:
                                ...
                                return JSONResponse(
                                    ...
                                    content={
                                        "status": True,
                                        "redirect_url": f"{logout_url}?id_token_hint={oauth_id_token}&client_id={OAUTH_CLIENT_ID.value}&post_logout_redirect_uri={WEBUI_AUTH_SIGNOUT_REDIRECT_URL}",
                                    },
